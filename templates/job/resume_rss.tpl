[row_resume]
<item>
<title>{specialty} ({sphere})</title>
<guid isPermaLink="false">{rsslink}</guid>
<link>{rsslink}</link>
<description><![CDATA[<table width="100%" cellpadding="0px" cellspacing="0px">
<tr>
	<td width="50%">
<strong>Ищет работу </strong> {specialty} ({sphere})<br />
<strong>Расположение:</strong> [country]{country}/[/country][city]{city}[/city]<br />
[salary]<strong>Зарплата:</strong> {salary}<br />[/salary]
[sex]<strong>Пол:</strong> {sex}[/sex]<br />
[age]<strong>Возраст:</strong> {age}[/age]<br />
...
<!-- <dc:creator>{rss_email}</dc:creator> -->
<pubDate>{rss_add_date}</pubDate>
</item>
[/row_resume]